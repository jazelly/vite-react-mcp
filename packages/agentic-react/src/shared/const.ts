export const __AGENTIC_REACT_TOOLS__ = '__AGENTIC_REACT_TOOLS__';
export const __AGENTIC_REACT__ = '__AGENTIC_REACT__';
export const __AGENTIC_REACT_CONFIG__ = '__AGENTIC_REACT_CONFIG__';
export const __AGENTIC_REACT_BRIDGE_URL__ = '__AGENTIC_REACT_BRIDGE_URL__';
