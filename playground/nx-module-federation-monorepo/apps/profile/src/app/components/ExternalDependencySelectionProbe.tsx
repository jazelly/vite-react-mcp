import { Button, Card, CardBody, HStack, Heading, Text } from '@chakra-ui/react';
          ...
          <HStack align="flex-start" spacing={3}>
            ...
            <div>
              ...
              <Text color="gray.600" lineHeight="1.7" mt={2}>
                ...
                button so selector tests can attribute a package component back to
                the project file that uses it.
              </Text>
            </div>
          </HStack>
          <Button colorScheme="green" id="profile-external-component-probe" size="sm">
            Review access note
          </Button>
        </HStack>
      </CardBody>
