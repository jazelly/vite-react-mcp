  ...
  return (
    <Stack id="profile-remote" spacing={5}>
      <RemotePageHeader
        ...
        title="Federated team profile routes."
      >
      ...
      <SimpleGrid columns={{ base: 1, md: 3 }} spacing={4}>
        <MetricCard
          help="profile/Routes owns this full customer context."
          label="Remote owner"
          value="profile"
        />
        <MetricCard
          help="Three accountable contacts can approve work."
          label="Household leads"
          value={String(householdMembers.length)}
        />
        <MetricCard
          help="Stable member card ids remain selectable."
      ...
      <SimpleGrid columns={{ base: 1, md: 2 }} spacing={4}>
        ...
        <PreferencePanel icon={AcademicCapIcon} title="Runtime exercise">
          Nested Chakra cards, tags, stats, lists, avatars, and icon wrappers
          remain visible to component tree, selection context, highlight, and
          source-code tools.
        </PreferencePanel>
        <PreferencePanel icon={ShieldCheckIcon} title="Privacy posture">
          Household notes are specific enough for service coordination but
          scoped to operational needs rather than exposing unnecessary personal
          detail.
        </PreferencePanel>
        <PreferencePanel icon={MapPinIcon} title="Route ownership">
          The profile remote can change household data capture without requiring
          the services catalog team to redeploy its marketplace routes.
        </PreferencePanel>
      </SimpleGrid>
    </Stack>
  );
